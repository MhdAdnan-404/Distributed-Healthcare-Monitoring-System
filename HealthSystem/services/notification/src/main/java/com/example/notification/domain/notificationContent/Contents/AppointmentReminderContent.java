...
@Getter
@Setter
public class AppointmentReminderContent implements InotificationContent {
    ...
    public String toString() {
        ...
        return String.format(
                "Reminder: Appointment ID %d is scheduled between Dr. %s and patient %s at %s.",
                appointmentId,
                doctorName,
                patientName,
    ...
    public void process(NotificationService notificationService) {
        notificationService.processAppointmentReminder(this);
    }
}
